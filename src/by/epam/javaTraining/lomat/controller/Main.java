...
package by.epam.javaTraining.lomat.controller;

public class Main {
    public static void main(String[] args) {
////        RockSong rockSong = new RockSong("Metallica - Enter Sandman", 300, 200, "USA", 1991, true, 20);
////        RockSong rockSong1 = new RockSong("Metallica - The Unforgiven", 500, 20, "USA", 1991, true, 70);

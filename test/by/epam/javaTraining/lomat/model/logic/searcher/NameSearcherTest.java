...
public class NameSearcherTest {
    ...
    public static Collection<Object[]> getParameters() {
        RockSong rockSong1 = new RockSong("1", 300, 200, "2", 1991, true, 20);
        RockSong rockSong2 = new RockSong("1", 500, 20, "2", 1991, false, 70);
        RapSong rapSong1 = new RapSong("2", 320, 20, "2", 1995, "2", "3");
